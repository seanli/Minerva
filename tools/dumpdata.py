...
result = os.system('%s ../%smanage.py dumpdata --indent=4 --natural --exclude=contenttypes --exclude=auth.Permission > ../schoolax/%sfixtures/%s.json' % (executable, directory, directory, fixture_name))
