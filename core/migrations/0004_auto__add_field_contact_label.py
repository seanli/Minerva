...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mva_contact', 'label', self.gf('django.db.models.fields.CharField')(default='test', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.label'
        db.delete_column('mva_contact', 'label')
