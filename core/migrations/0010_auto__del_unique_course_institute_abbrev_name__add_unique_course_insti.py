...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Course', fields ['institute', 'abbrev', 'name']
        db.delete_unique('mva_course', ['institute_id', 'abbrev', 'name'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Course', fields ['institute', 'abbrev', 'name']
        db.create_unique('mva_course', ['institute_id', 'abbrev', 'name'])
    ...
    models = {
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 1, 1, 34, 876123)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 1, 1, 34, 877571)'})
        },
        'core.institute': {
        ...
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 1, 1, 34, 876856)'})
        },
        'core.section': {
