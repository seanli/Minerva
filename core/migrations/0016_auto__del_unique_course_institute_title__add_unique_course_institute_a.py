...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Course', fields ['institute', 'abbrev', 'title']
        db.create_unique('mva_course', ['institute_id', 'abbrev', 'title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Course', fields ['institute', 'abbrev', 'title']
        db.delete_unique('mva_course', ['institute_id', 'abbrev', 'title'])
    ...
    models = {
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 10, 3, 609782)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 10, 3, 610746)'})
        },
        'core.institute': {
        ...
        'core.report': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 10, 3, 611197)'})
        },
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 10, 3, 610275)'})
        },
        'core.section': {
