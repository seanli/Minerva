...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mva_feedback', (
            ...
            ('instructor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Profile'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('person_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_person_from', to=orm['core.Profile'])),
            ('sent_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 3, 17, 5, 46, 484001))),
    ...
    models = {
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 17, 5, 46, 482847)'})
        },
        'core.faculty': {
        ...
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 17, 5, 46, 484001)'})
        },
        'core.institute': {
        ...
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 17, 5, 46, 483492)'})
        },
        'core.section': {
