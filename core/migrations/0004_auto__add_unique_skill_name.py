...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('mva_skill', ['name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Skill', fields ['name']
        db.delete_unique('mva_skill', ['name'])
    ...
    models = {
        ...
        'core.skillrating': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rater': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'skillrating_rater'", 'to': "orm['auth.User']"}),
