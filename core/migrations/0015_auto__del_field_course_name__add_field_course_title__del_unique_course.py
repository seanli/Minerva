...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Course', fields ['institute', 'name']
        db.delete_unique('mva_course', ['institute_id', 'name'])

        # Deleting field 'Course.name'
        db.delete_column('mva_course', 'name')

        # Adding field 'Course.title'
        db.add_column('mva_course', 'title', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)

        # Adding unique constraint on 'Course', fields ['institute', 'title']
        db.create_unique('mva_course', ['institute_id', 'title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Course', fields ['institute', 'title']
        db.delete_unique('mva_course', ['institute_id', 'title'])

        # Adding field 'Course.name'
        db.add_column('mva_course', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)

        # Deleting field 'Course.title'
        db.delete_column('mva_course', 'title')

        # Adding unique constraint on 'Course', fields ['institute', 'name']
        db.create_unique('mva_course', ['institute_id', 'name'])
    ...
    models = {
        ...
        'core.course': {
            'Meta': {'unique_together': "(('title', 'institute'),)", 'object_name': 'Course', 'db_table': "'mva_course'"},
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 20, 7, 12, 522441)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 20, 7, 12, 523453)'})
        },
        'core.institute': {
        ...
        'core.report': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 20, 7, 12, 524000)'})
        },
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 20, 7, 12, 522947)'})
        },
        'core.section': {
