...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SkillRating'
        db.create_table('mva_skill_rating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rater', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('skill_assign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SkillAssign'])),
            ('rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('core', ['SkillRating'])

        # Adding unique constraint on 'SkillRating', fields ['rater', 'skill_assign']
        db.create_unique('mva_skill_rating', ['rater_id', 'skill_assign_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'SkillRating', fields ['rater', 'skill_assign']
        db.delete_unique('mva_skill_rating', ['rater_id', 'skill_assign_id'])

        # Deleting model 'SkillRating'
        db.delete_table('mva_skill_rating')
