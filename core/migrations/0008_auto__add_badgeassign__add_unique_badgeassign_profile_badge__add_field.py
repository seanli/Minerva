...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.influence'
        db.add_column('mva_profile', 'influence', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.influence'
        db.delete_column('mva_profile', 'influence')
