...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mva_profile', (
            ...
            ('tagline', self.gf('django.db.models.fields.TextField')(null=True)),
            ('instutute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Institute'])),
        ))
    ...
    models = {
        ...
        'core.profile': {
            ...
            'tagline': ('django.db.models.fields.TextField', [], {'null': 'True'}),
