...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skill.modified_time'
        db.add_column('mva_skill', 'modified_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 16, 3, 0, 22, 53888), auto_now=True, blank=True), keep_default=False)

        # Changing field 'Course.modified_time'
        db.alter_column('mva_course', 'modified_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Adding field 'Specialization.modified_time'
        db.add_column('mva_specialization', 'modified_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 16, 3, 0, 22, 53015), auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skill.modified_time'
        db.delete_column('mva_skill', 'modified_time')

        # Changing field 'Course.modified_time'
        db.alter_column('mva_course', 'modified_time', self.gf('django.db.models.fields.DateTimeField')())

        # Deleting field 'Specialization.modified_time'
        db.delete_column('mva_specialization', 'modified_time')
    ...
    models = {
        ...
        'core.course': {
            ...
            'modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 56578)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 61744)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 62925)'})
        },
        'core.institute': {
        ...
        'core.report': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'reporter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'report_reporter'", 'null': 'True', 'to': "orm['core.Profile']"}),
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 63503)'})
        },
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 62346)'})
        },
        'core.section': {
        ...
        'core.skill': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 53888)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'core.specialization': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 3, 0, 22, 53015)', 'auto_now': 'True', 'blank': 'True'}),
