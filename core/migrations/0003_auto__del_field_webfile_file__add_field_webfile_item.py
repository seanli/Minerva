...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WebFile.file'
        db.delete_column('mva_webfile', 'file')

        # Adding field 'WebFile.item'
        db.add_column('mva_webfile', 'item',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'WebFile.file'
        db.add_column('mva_webfile', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)

        # Deleting field 'WebFile.item'
        db.delete_column('mva_webfile', 'item')
