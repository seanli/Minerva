...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('mva_specialization', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Specialization', fields ['name']
        db.delete_unique('mva_specialization', ['name'])
    ...
    models = {
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 13, 23, 33, 4, 139319)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 13, 23, 33, 4, 140587)'})
        },
        'core.institute': {
        ...
        'core.report': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 13, 23, 33, 4, 141087)'})
        },
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 13, 23, 33, 4, 140053)'})
        },
        'core.section': {
