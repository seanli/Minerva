...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.req_exp'
        db.add_column('mva_badge', 'req_exp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Changing field 'Badge.next_exp'
        db.alter_column('mva_badge', 'next_exp', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Adding field 'BadgeAssign.obtained'
        db.add_column('mva_badge_assign', 'obtained', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.req_exp'
        db.delete_column('mva_badge', 'req_exp')

        # Changing field 'Badge.next_exp'
        db.alter_column('mva_badge', 'next_exp', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Deleting field 'BadgeAssign.obtained'
        db.delete_column('mva_badge_assign', 'obtained')
    ...
    models = {
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 18, 0, 4, 635587)'})
        },
        'core.faculty': {
        ...
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 18, 0, 4, 636718)'})
        },
        'core.institute': {
        ...
        'core.profile': {
            ...
            'degree': ('django.db.models.fields.CharField', [], {'default': "'UG'", 'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 18, 0, 4, 636230)'})
        },
        'core.section': {
