...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Report'
        db.create_table('mva_report', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='report_reporter', null=True, to=orm['core.Profile'])),
            ('sent_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 11, 0, 24, 33, 540020))),
        ))
    ...
    models = {
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 0, 24, 33, 538555)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 0, 24, 33, 539559)'})
        },
        'core.institute': {
        ...
        'core.report': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 0, 24, 33, 540020)'})
        },
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 0, 24, 33, 539064)'})
        },
        'core.section': {
