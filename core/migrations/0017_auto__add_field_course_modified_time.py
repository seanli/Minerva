...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.modified_time'
        db.add_column('mva_course', 'modified_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 16, 2, 37, 36, 469320)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.modified_time'
        db.delete_column('mva_course', 'modified_time')
    ...
    models = {
        ...
        'core.course': {
            ...
            'modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 37, 36, 469320)'}),
        ...
        'core.encouragement': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 37, 36, 470845)'})
        },
        'core.feedback': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 37, 36, 471794)'})
        },
        'core.institute': {
        ...
        'core.report': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 37, 36, 472241)'})
        },
        'core.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 2, 37, 36, 471323)'})
        },
        'core.section': {
