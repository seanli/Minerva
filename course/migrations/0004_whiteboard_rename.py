...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('mva_white_board_post', 'mva_whiteboard_post')
        db.rename_table('mva_white_board_comment', 'mva_whiteboard_comment')
    def backwards(self, orm):
        db.rename_table('mva_whiteboard_post', 'mva_white_board_post')
        db.rename_table('mva_whiteboard_comment', 'mva_white_board_comment')
    models = {
        'auth.group': {
        ...
        'course.whiteboardcomment': {
            'Meta': {'object_name': 'WhiteboardComment', 'db_table': "'mva_whiteboard_comment'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['course.WhiteboardPost']"})
        },
        'course.whiteboardpost': {
            'Meta': {'object_name': 'WhiteboardPost', 'db_table': "'mva_whiteboard_post'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
