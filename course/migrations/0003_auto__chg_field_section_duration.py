...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Section.duration'
        db.alter_column('mva_section', 'duration', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'Section.duration'
        db.alter_column('mva_section', 'duration', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        'course.review': {
            ...
            'sent_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 15, 17, 18, 56, 473000)'})
        },
        'course.section': {
