...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WhiteBoardComment'
        db.create_table('mva_white_board_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.WhiteBoardPost'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('course', ['WhiteBoardComment'])

        # Adding model 'WhiteBoardPost'
        db.create_table('mva_white_board_post', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('course', ['WhiteBoardPost'])

    def backwards(self, orm):
        # Deleting model 'WhiteBoardComment'
        db.delete_table('mva_white_board_comment')

        # Deleting model 'WhiteBoardPost'
        db.delete_table('mva_white_board_post')
    ...
    models = {
        ...
        'course.whiteboardcomment': {
            'Meta': {'object_name': 'WhiteBoardComment', 'db_table': "'mva_white_board_comment'"},
        ...
        'course.whiteboardpost': {
            'Meta': {'object_name': 'WhiteBoardPost', 'db_table': "'mva_white_board_post'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
