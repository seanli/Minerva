...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mva_course_rating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rater', self.gf('django.db.models.fields.related.ForeignKey')(related_name='courserating_rater', to=orm['auth.User'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Course'])),
            ('interesting_value', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('practical_value', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('difficult_value', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('course', ['CourseRating'])

        # Adding unique constraint on 'CourseRating', fields ['rater', 'course']
        db.create_unique('mva_course_rating', ['rater_id', 'course_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'CourseRating', fields ['rater', 'course']
        db.delete_unique('mva_course_rating', ['rater_id', 'course_id'])

        # Deleting model 'CourseRating'
        db.delete_table('mva_course_rating')
    ...
    models = {
        ...
        'course.courserating': {
            'Meta': {'unique_together': "(('rater', 'course'),)", 'object_name': 'CourseRating', 'db_table': "'mva_course_rating'"},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['course.Course']"}),
            'difficult_value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interesting_value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'practical_value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'rater': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'courserating_rater'", 'to': "orm['auth.User']"})
        },
        'course.review': {
