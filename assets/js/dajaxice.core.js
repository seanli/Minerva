var Dajaxice = {
        ...
        crowd: {
            ...
            form_encouragement: function(callback_function, argv, custom_settings){
                Dajaxice.call('crowd.form_encouragement', callback_function, argv, custom_settings);
            },
    
            
            form_add_specialization: function(callback_function, argv, custom_settings){
                Dajaxice.call('crowd.form_add_specialization', callback_function, argv, custom_settings);
            },
    
            
            form_add_skill: function(callback_function, argv, custom_settings){
                Dajaxice.call('crowd.form_add_skill', callback_function, argv, custom_settings);
            },
    
            
            plus_exp: function(callback_function, argv, custom_settings){
                Dajaxice.call('crowd.plus_exp', callback_function, argv, custom_settings);
            },
    
            
            minus_exp: function(callback_function, argv, custom_settings){
                Dajaxice.call('crowd.minus_exp', callback_function, argv, custom_settings);
            }
