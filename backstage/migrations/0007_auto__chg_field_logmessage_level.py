...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogMessage.level'
        db.alter_column('bsg_log_message', 'level', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'LogMessage.level'
        db.alter_column('bsg_log_message', 'level', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    models = {
        'auth.group': {
