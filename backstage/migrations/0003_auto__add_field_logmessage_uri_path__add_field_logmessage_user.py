...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogMessage.uri_path'
        db.add_column('bsg_log_message', 'uri_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LogMessage.user'
        db.add_column('bsg_log_message', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LogMessage.uri_path'
        db.delete_column('bsg_log_message', 'uri_path')

        # Deleting field 'LogMessage.user'
        db.delete_column('bsg_log_message', 'user_id')
