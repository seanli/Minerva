...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LogMessage.file_name'
        db.delete_column('bsg_log_message', 'file_name')

        # Deleting field 'LogMessage.module'
        db.delete_column('bsg_log_message', 'module')

        # Adding field 'LogMessage.file_path'
        db.add_column('bsg_log_message', 'file_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'LogMessage.file_name'
        db.add_column('bsg_log_message', 'file_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LogMessage.module'
        db.add_column('bsg_log_message', 'module',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LogMessage.file_path'
        db.delete_column('bsg_log_message', 'file_path')
    ...
    models = {
        ...
        'backstage.logmessage': {
            'Meta': {'object_name': 'LogMessage', 'db_table': "'bsg_log_message'"},
