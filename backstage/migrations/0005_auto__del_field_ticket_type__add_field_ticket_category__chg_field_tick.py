...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('bsg_ticket', 'type')

        # Adding field 'Ticket.category'
        db.add_column('bsg_ticket', 'category', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Changing field 'Ticket.status'
        db.alter_column('bsg_ticket', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Adding field 'Ticket.type'
        db.add_column('bsg_ticket', 'type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Deleting field 'Ticket.category'
        db.delete_column('bsg_ticket', 'category')

        # Changing field 'Ticket.status'
        db.alter_column('bsg_ticket', 'status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
