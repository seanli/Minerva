...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogMessage.traceback'
        db.add_column('bsg_log_message', 'traceback',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LogMessage.request'
        db.add_column('bsg_log_message', 'request',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LogMessage.traceback'
        db.delete_column('bsg_log_message', 'traceback')

        # Deleting field 'LogMessage.request'
        db.delete_column('bsg_log_message', 'request')
