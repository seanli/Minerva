var Dajaxice = {
        ...
        core: {
            ...
            helloworld: function(callback_function, argv, custom_settings){
                Dajaxice.call('core.helloworld', callback_function, argv, custom_settings);
            }
        ...
        backstage: {
            ...
            form_report: function(callback_function, argv, custom_settings){
                Dajaxice.call('backstage.form_report', callback_function, argv, custom_settings);
            }
        ...
        course: {
            ...
            rate_course: function(callback_function, argv, custom_settings){
                Dajaxice.call('course.rate_course', callback_function, argv, custom_settings);
            }
        ...
        account: {
            ...
            swap_user: function(callback_function, argv, custom_settings){
                Dajaxice.call('account.swap_user', callback_function, argv, custom_settings);
            }
        ...
        homeroom: {
            ...
            form_add_course: function(callback_function, argv, custom_settings){
                Dajaxice.call('homeroom.form_add_course', callback_function, argv, custom_settings);
            },
    
            
            form_whiteboard_post: function(callback_function, argv, custom_settings){
                Dajaxice.call('homeroom.form_whiteboard_post', callback_function, argv, custom_settings);
            },
    
            
            unsubscribe_section: function(callback_function, argv, custom_settings){
                Dajaxice.call('homeroom.unsubscribe_section', callback_function, argv, custom_settings);
            }
        ...
        portfolio: {
            ...
            form_encouragement: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.form_encouragement', callback_function, argv, custom_settings);
            },
    
            
            form_add_specialization: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.form_add_specialization', callback_function, argv, custom_settings);
            },
    
            
            form_add_skill: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.form_add_skill', callback_function, argv, custom_settings);
            },
    
            
            approve_encouragement: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.approve_encouragement', callback_function, argv, custom_settings);
            },
    
            
            rate_skill: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.rate_skill', callback_function, argv, custom_settings);
            },
    
            
            plus_exp: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.plus_exp', callback_function, argv, custom_settings);
            },
    
            
            minus_exp: function(callback_function, argv, custom_settings){
                Dajaxice.call('portfolio.minus_exp', callback_function, argv, custom_settings);
            }
