...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mva_profile', 'grade', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Profile.grade_gauge'
        db.add_column('mva_profile', 'grade_gauge', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.grade'
        db.delete_column('mva_profile', 'grade')

        # Deleting field 'Profile.grade_gauge'
        db.delete_column('mva_profile', 'grade_gauge')
